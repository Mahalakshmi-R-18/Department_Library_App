...
class FacultyActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun logoutUser() {
        ...
        finish() // Optionally, finish the FacultyActivity after starting LoginActivity
    }
